...
def semantic_lidar_data1(point_cloud_data):
    ...
    for detection in point_cloud_data:
        ...
        if distance_name_data['name'] == 'Vehicles' and distance_name_data['distance'] > 3 and distance_name_data['distance'] < 8:
...
try:
    ...
    police_car_spawn_point = world.get_map().get_spawn_point()[15]
