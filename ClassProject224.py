...
def Bike_control():
    ...
    dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.3, steer = -0.38))
    dropped_vehicle.set_light_state(carla.VehicleLightState.LeftBlinker | carla.VehicleLightState.HighBeam | carla.VehicleLightState.Brake)
    time.sleep(2)

    dropped_vehicle.apply_control(carla.VehicleControl(throttle = 0.31))
    dropped_vehicle.set_light_state(carla.VehicleLightState.HighBeam | carla.VehicleLightState.Brake)
    time.sleep(3)
...
try:
    ...
    car_model = get_blueprint_of_world.filtet('vehicle.yamaha.yzf')[0] #write code for selecting vehicle as bike
