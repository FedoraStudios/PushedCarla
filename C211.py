...
def number_of_vehicles():
	...
	threading.Timer(0.1, number_of_vehicles).start()
...
try: 
    ...
    def _on_collision(data):
    	...
    	intensity_of_collision = math.sqrt(collision.event.record.x**2 + collision.event.record.y**2 + collision.event.record.z**2)
