...
class KeyboardControl(object):
    ...
    def _parse_vehicle_keys(self, keys, miliseconds):
        driving_data = {}
        ...
        steer_increment = 0.0005*miliseconds

        if keys[K_LEFT] or keys[K_a]:
            if self._steer_cache is > 0:
                self._steer_cache = 0
            ...
            if self._steer_cache is < 0:
                ...
                self._steer_cache = self_steer_cache + steer_increment
        ...
        writer.write header()
        writer.write rows(store_driving_data)
