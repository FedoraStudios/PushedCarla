...
def generate_lidar_blueprint(blueprint_library):
    ...
    lidar_blueprint = blueprint_library.find('sensor.lidar.ray_cast_semnatic')
...
def semantic_lidar_data(point_cloud, lidar_point_cloud_buffer):
    ...
    labels = np.array([matrix_representational_data['x'], - matrix_representational_data['y'], - matrix_representational_data['z']]).T
    lidar_point_cloud_buffer['bts'] = lidar_points
    lidar_point_cloud_buffer['intensity'] = lidar_points
